...
<body>
    ...
    <section class="py-5 text-center container">
        <div class="col-lg-6 col-md-8 mx-auto">
            ...
            <p class="lead text-muted">FREE WORLDWIDE SHIPPING ON ALL ORDERS</p>
          ...
          <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="produk.php?id_buku=<?=$data_produk['id_produk']?>" type="button" class="w-50 btn btn-lg btn-primary">Lihat Detail</a>
                    </div>
